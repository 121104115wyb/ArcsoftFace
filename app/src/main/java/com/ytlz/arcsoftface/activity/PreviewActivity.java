    ...
    private void initCamera() {
        ...
        CameraListener cameraListener = new CameraListener() {
            ...
            public void onPreview(byte[] nv21, Camera camera) {
                ...
                if (faceRectView != null && drawHelper1 != null) {
                    List<DrawInfo1> drawInfo1List = new ArrayList<>();
                    for (int i = 0; i < faceInfoList.size(); i++) {
                        drawInfo1List.add(new DrawInfo1(faceInfoList.get(i).getRect(), genderInfoList.get(i).getGender(), ageInfoList.get(i).getAge(), faceLivenessInfoList.get(i).getLiveness(), null));
                    }
