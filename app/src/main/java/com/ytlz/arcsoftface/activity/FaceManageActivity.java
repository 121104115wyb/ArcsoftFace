...
import com.ytlz.arcsoftface.widget.ProgressDialog;
...
public class FaceManageActivity extends AppCompatActivity {
    ...
    private void doRegister() {
        ...
        final File[] jpgFiles = dir.listFiles(new FilenameFilter() {
            ...
            public boolean accept(File dir, String name) {
                return name.endsWith(FaceServer1.IMG_SUFFIX);
            }
        });
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < totalCount; i++) {
                    ...
                    boolean success = FaceServer1.getInstance().register(FaceManageActivity.this, nv21, bitmap.getWidth(), bitmap.getHeight(),
    ...
    public void clearFaces(View view) {
        int faceNum = FaceServer1.getInstance().getFaceNumber(this);
        if (faceNum == 0){
            ...
            AlertDialog dialog = new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            int deleteCount = FaceServer1.getInstance().clearAllFaces(FaceManageActivity.this);
