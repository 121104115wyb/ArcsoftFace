...
public class CameraHelper1 implements Camera.PreviewCallback {
    private static final String TAG = "CameraHelper1";
    ...
    private CameraHelper1(CameraHelper1.Builder builder) {
